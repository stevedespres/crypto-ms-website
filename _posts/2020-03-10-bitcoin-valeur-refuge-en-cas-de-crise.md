...
L'or a également un avantage prépondérant dans **son utilisation** de valeur refuge. Il est acheté en **grande quantité** par **les États, les banques, les organismes internationaux, etc**. Ces institutions font cela pour **augmenter leur couverture** en prévention d’une crise. Lors d'une crise financière, les États auront ainsi tendance à **augmenter leur stock d'or**, ce qui fera **augmenter son cours** alors même que **les marchés financiers chuteront**. 
